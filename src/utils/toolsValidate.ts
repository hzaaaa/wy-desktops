...
/**
 * 营销平台新密码验证 (长度大于6位，包含数字、字母)
 * @param val 当前值字符串
 */
export const PASSWORD_PATTERN = /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9a-zA-Z]{6,16}$/;
export function verifyNewPassword(val: string) {
  return PASSWORD_PATTERN.test(val);
}
